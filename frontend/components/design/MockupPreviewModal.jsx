        ...
        <AnimatePresence>
            ...
            >
                <motion.div
                    ...
                    className="relative w-full max-w-[95vw] sm:max-w-3xl lg:max-w-4xl max-h-[95vh] overflow-hidden bg-gradient-to-br from-gray-900 to-black border border-gray-800 rounded-xl sm:rounded-2xl shadow-2xl"
