...
export default function About() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-black via-red-950/20 to-black pt-16 sm:pt-20 pb-8 sm:pb-12">
      <div className="max-w-4xl mx-auto px-3 sm:px-4">
        {/* Header */}
        <div className="text-center mb-10 sm:mb-16">
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-pink-600 to-red-600 text-white px-3 sm:px-4 py-1.5 sm:py-2 rounded-full text-xs sm:text-sm font-semibold mb-4 sm:mb-6 shadow-lg shadow-pink-600/30">
            <Heart className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
            About DesignForWear
          </div>
          <h1 className="text-3xl sm:text-4xl md:text-6xl font-black text-white tracking-tight mb-3 sm:mb-4">
        ...
        <div className="space-y-8 sm:space-y-12">
          {/* Mission Section */}
          <section className="bg-gradient-to-br from-red-950/30 via-pink-950/20 to-red-950/30 rounded-xl sm:rounded-2xl p-5 sm:p-8 border border-pink-900/30 backdrop-blur-sm">
          ...
          {/* What We Do Section */}
          <section className="bg-gradient-to-br from-red-950/30 via-pink-950/20 to-red-950/30 rounded-xl sm:rounded-2xl p-5 sm:p-8 border border-pink-900/30 backdrop-blur-sm">
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-4 sm:mb-6">What We Do</h2>
          ...
          {/* Get Started Section */}
          <section className="bg-gradient-to-br from-red-950/30 via-pink-950/20 to-red-950/30 rounded-xl sm:rounded-2xl p-5 sm:p-8 border border-pink-900/30 backdrop-blur-sm">
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-4 sm:mb-6">Get Started</h2>
            <p className="text-white/80 leading-relaxed text-base sm:text-lg mb-6 sm:mb-8">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
              <Link to={createPageUrl('DesignStudio')} className="flex-1 sm:flex-initial">
                <button className="w-full group bg-gradient-to-r from-pink-600 to-red-600 hover:from-pink-700 hover:to-red-700 text-white px-6 sm:px-8 py-3.5 sm:py-4 rounded-xl sm:rounded-full font-bold transition-all shadow-lg shadow-pink-600/50 hover:shadow-pink-600/70 hover:scale-105 flex items-center justify-center gap-2 text-sm sm:text-base">
                  <Sparkles className="w-4 h-4 sm:w-5 sm:h-5" />
                  Create Your Shirt
                </button>
              </Link>
              <Link to={createPageUrl('home')} className="flex-1 sm:flex-initial">
                <button className="w-full border-2 border-pink-600/50 hover:border-pink-600 hover:bg-pink-600/10 text-white px-6 sm:px-8 py-3.5 sm:py-4 rounded-xl sm:rounded-full font-bold transition-all flex items-center justify-center gap-2 text-sm sm:text-base">
                  Browse Templates
                </button>
              </Link>
            </div>
        ...
        <div className="mt-10 sm:mt-16 text-center">
          <p className="text-white/40 text-xs sm:text-sm flex items-center justify-center gap-2">
            Made with <Heart className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-pink-500" /> by DesignForWear
          </p>
